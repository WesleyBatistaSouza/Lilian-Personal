...
import personagemLilian from "./assets/personagem_lilian.png";
import logoLilian from "../public/lilian_icon.png";
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-lg flex items-center justify-center">
                <span className="text-2xl font-bold"><img src={logoLilian}></img></span>
              </div>
              <div>
